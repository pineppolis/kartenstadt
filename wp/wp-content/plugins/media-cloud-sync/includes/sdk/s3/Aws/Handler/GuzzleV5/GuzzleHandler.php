...
use Dudlewebs\WPMCS\s3\GuzzleHttp\Event\EndEvent;
use Dudlewebs\WPMCS\s3\GuzzleHttp\Exception\ConnectException;
use Dudlewebs\WPMCS\s3\GuzzleHttp\Exception\RequestException;
use Dudlewebs\WPMCS\s3\GuzzleHttp\Message\ResponseInterface as GuzzleResponse;
use Dudlewebs\WPMCS\s3\GuzzleHttp\Promise;
use Dudlewebs\WPMCS\s3\GuzzleHttp\Psr7\Response as Psr7Response;
use Dudlewebs\WPMCS\s3\GuzzleHttp\Stream\Stream;
