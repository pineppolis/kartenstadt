...
class ClientResolver
{
    ...
    public static function _apply_user_agent($inputUserAgent, array &$args, HandlerList $list)
    {
        ...
        if (isset($args['endpoint_discovery'])) {
            if ($args['endpoint_discovery'] instanceof \Dudlewebs\WPMCS\s3\Aws\EndpointDiscovery\Configuration && $args['endpoint_discovery']->isEnabled()) {
        ...
        if (isset($args['retries'])) {
            if ($args['retries'] instanceof \Dudlewebs\WPMCS\s3\Aws\Retry\Configuration) {
    ...
    {
        return ConfigurationResolver::resolve('sigv4a_signing_region_set', '', 'string');
    }
