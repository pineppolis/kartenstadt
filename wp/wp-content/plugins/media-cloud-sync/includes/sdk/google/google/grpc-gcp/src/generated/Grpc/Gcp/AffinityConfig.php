 ...
 */
class AffinityConfig extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\Grpc\Gcp\AffinityConfig_Command::class);
        $this->command = $var;
        return $this;
    }
    /**
