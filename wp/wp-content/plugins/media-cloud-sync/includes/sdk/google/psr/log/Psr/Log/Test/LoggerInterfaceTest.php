...
namespace Dudlewebs\WPMCS\Psr\Log\Test;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Dudlewebs\WPMCS\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Dudlewebs\WPMCS\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Dudlewebs\WPMCS\Psr\Log\Test\DummyTest', array('__toString'));
        }
